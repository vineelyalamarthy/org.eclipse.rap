...
public class LifeCycleRequestWithException_Test extends TestCase {
  ...
  private static final String EXCEPTION_MESSAGE = "Exception Test Message";
  
  private final class ExceptionHandler implements PhaseListener {
    private static final long serialVersionUID = 1L;
    public void afterPhase( final PhaseEvent event ) {
    }
    public void beforePhase( final PhaseEvent event ) {
      FormManager.getActive().addWebRenderListener( new WebRenderAdapter() {
  ...
  public void testExceptionOnStartup() throws Exception {
    ...
    assertTrue( allMarkup.indexOf( EXCEPTION_MESSAGE ) != -1 );
  }
  ...
  public void testExceptionDuringStandardRequest() throws Exception {
    ...
    String expected
      =   "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">"
        ...
        + "src=\"/resources/js/eventhandler/eventhandler_ie.js\" " 
        + "type=\"text/javascript\">" 
        + "</script>" 
        + "<script charset=\"UTF-8\" " 
        + "src=\"/resources/js/windowmanager/windowmanager.js\" " 
        + "type=\"text/javascript\">" 
        + "</script>" 
