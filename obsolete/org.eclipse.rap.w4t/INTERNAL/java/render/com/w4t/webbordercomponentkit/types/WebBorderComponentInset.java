...
/** implementation of the INSET state of the WebBorderComponent
 */
class WebBorderComponentInset extends WebBorderComponentType {

  WebBorderComponentInset( final WebBorderComponent webBorderComponent ) {
    super( webBorderComponent );
  }
    
  public int getBorderType() {
    return WebBorderComponent.INSET;
  }
