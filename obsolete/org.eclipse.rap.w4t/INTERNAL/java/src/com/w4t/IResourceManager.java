...
public interface IResourceManager {
  ...
  /**
   * <p>An enumeration used to specify additional behaviour when registering
   * a resource.</p>
   * <ul><li><code>NONE</code> - no further action is taken.</li>
   * <li><code>VERSION</code> - the resource to be registered will be versioned.
   * </li>
   ...
   *              'my.gif' located within the package 'com.w4t' is identified
   *              as 'com/w4t/my.gif'. Must not be <code>null</code>. 
   */
  ...
  /** <p>returns a location within the web-applications context where the 
   *  resource will be available for the browser to download. If the
   ...
   * for the W4Toolkit context loader. May return <code>null</code> if no
