 ...
 * @see com.w4t.W4TContext#getBrowser() W4TContext.getBrowser()
 */
public abstract class Browser {
  ...
  private static final String PACKAGE = "com.w4t.util.browser.";
   ...
   *          definitions in {@link com.w4t.Browser Browser}
   */
