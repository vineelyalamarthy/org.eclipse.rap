...
/**
 * Contains static methods for performing simple geometric operations on the SWT
 * geometry classes.
 * 
 * @since 3.0
 */
public class Geometry {
   ...
   * Directions are given using SWT direction constants, and the resulting
   ...
   *          this is positive).
   * @param orientation the side to extrude. One of SWT.LEFT, SWT.RIGHT,
   *          SWT.TOP, or SWT.BOTTOM. The resulting rectangle will always share
   ...
   * 
   * @param rwtDirectionConstant one of SWT.LEFT, SWT.RIGHT, SWT.TOP, or
   *          SWT.BOTTOM
   ...
   * 
   * @param horizontal if true, returns SWT.HORIZONTAL. If false, returns
   *          SWT.VERTICAL
  ...
  /**
   * Returns true iff the given SWT side constant corresponds to a horizontal
  ...
  public static boolean isHorizontal( int rwtSideConstant ) {
    return !( rwtSideConstant == SWT.LEFT || rwtSideConstant == SWT.RIGHT );
  }
   ...
   * Returns a combination of SWT.LEFT, SWT.RIGHT, SWT.TOP, and SWT.BOTTOM,
   * combined with bitwise or (for example, returns SWT.TOP | SWT.LEFT if the
   ...
   *          computed
   * @return one of SWT.LEFT | SWT.TOP, SWT.TOP, SWT.RIGHT | SWT.TOP, SWT.LEFT,
   *         0, SWT.RIGHT, SWT.LEFT | SWT.BOTTOM, SWT.BOTTOM, SWT.RIGHT |
   *         SWT.BOTTOM
   * @since 3.0
   */
  ...
  public static int getClosestSide( Rectangle boundary, Point toTest ) {
    int[] sides = new int[]{
      SWT.LEFT, SWT.RIGHT, SWT.TOP, SWT.BOTTOM
    };
