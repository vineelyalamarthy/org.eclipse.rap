 ...
 * to selection changed event if the selection change was triggered by the
 * mouse, but it has a delay if the selection change is triggered by keyboard
 * navigation.
 * 
...
public interface IPostSelectionProvider extends ISelectionProvider {
  ...
  /**
   * Adds a listener for post selection changes in this selection provider. Has
   ...
   * provider. Has no affect if an identical listener is not registered.
   * 
   * @param listener a selection changed listener
   */
