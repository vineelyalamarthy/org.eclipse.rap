...
public class TreePathViewerSorter extends ViewerSorter {
   ...
   * are root elements.
   * <p>
   * By default, the this method calls {@link ViewerSorter#category(Object)}.
   * Subclasses may override.
   * 
   * @param parentPath the parent path for the element
  ...
  /**
   * Compare the givcen elements that will have the given parent path when they
   * are added to the viewer. The provided path is relative to the viewer input.
   * The parent path will be <code>null</code> when the elements are root
   * elements.
   * <p>
   ...
   *         to the second element; and a positive
   */
   ...
   * given property of the given element. The provided path is relative to the
   * viewer input. The parent path will be <code>null</code> when the elements
   * are root elements.
   * <p>
   * The default implementation of this method calls
   * {@link ViewerSorter#isSorterProperty(Object, String)}. Subclasses may
   * reimplement.
   * 
  ...
  /**
   * Sorts the given elements in-place, modifying the given array. The provided
   * path is relative to the viewer input. The parent path will be
   * <code>null</code> when the elements are root elements.
   * <p>
   * The default implementation of this method uses the java.util.Arrays#sort
   * algorithm on the given array, calling
   * {@link #compare(Viewer, TreePath, Object, Object)} to compare elements.
   * </p>
   * <p>
