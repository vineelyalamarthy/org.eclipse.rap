...
public class DecorationOverlayIcon extends CompositeImageDescriptor {
     ...
     */
    public DecorationOverlayIcon(final Image baseImage,
            final ImageDescriptor[] overlaysArray, final Point sizeValue) {
        this.base = baseImage;
     ...
     * @param overlaysArray the overlay images
     */
    public DecorationOverlayIcon(final Image baseImage, final ImageDescriptor[] overlaysArray) {
	 ...
	 */
	public DecorationOverlayIcon(final Image baseImage, final ImageDescriptor overlayImage, final int quadrant) {
	...
	private static ImageDescriptor[] createArrayFrom(
			final ImageDescriptor overlayImage, final int quadrant) {
     ...
     * @param overlaysArray
     */
    private void drawOverlays(final ImageDescriptor[] overlaysArray) {
...
//                        .getImageData();
				overlayData = ResourceFactory.getImageData( ImageDescriptor.getMissingImageDescriptor().createImage() );
			}
            switch (i) {
...
//				drawImage(underlay.getImageData(), 0, 0);
				drawImage( ResourceFactory.getImageData( underlay.createImage() ), 0, 0 );
			}
    	}
//        drawImage(base.getImageData(), 0, 0);
        drawImage( ResourceFactory.getImageData( base ), 0, 0 );
