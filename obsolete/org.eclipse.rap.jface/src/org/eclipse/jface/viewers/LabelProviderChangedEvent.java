...
public class LabelProviderChangedEvent extends EventObject {
   ...
   * provided by the source for the given elements is no longer valid and should
   * be updated.
   * 
   * @param source the label provider
   * @param elements the element whose labels have changed
   */
  public LabelProviderChangedEvent( IBaseLabelProvider source, Object[] elements )
  {
    super( source );
  ...
  /**
   * Creates a new event for the given source, indicating that the label
   * provided by the source for the given element is no longer valid and should
   * be updated.
   * 
   * @param source the label provider
  ...
  /**
   * Returns the first element whose label needs to be updated, or
   * <code>null</code> if all labels need to be updated.
   * 
  ...
  /**
   * Returns the elements whose labels need to be updated, or <code>null</code>
