...
//		return OK;
	 ...
	 * @param callback 
	 */
	public static void /* int */ openError(Shell parent, String dialogTitle,
			String message, IStatus status, IWindowCallback callback) {
		openError(parent, dialogTitle, message, status, IStatus.OK
				| IStatus.INFO | IStatus.WARNING | IStatus.ERROR, callback );
	}
	 ...
	 * @see org.eclipse.core.runtime.IStatus#matches(int)
	 */
	public static void openError(Shell parentShell, String title,
