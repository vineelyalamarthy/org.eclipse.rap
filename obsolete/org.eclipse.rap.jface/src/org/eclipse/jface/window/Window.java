...
//		Rectangle monitorBounds = monitor.getClientArea();
		// TODO: [bm] getClientArea() == getBounds() on RAP ?
...
//	}
	 ...
	 * Opens this window, creating it first if it has not yet been created.
	 * <p>
	 * The IWindowCallback implementations gets notified when the window is
	 * closed and gets passed the return code of the dialog. 
	 * A window's return codes are
	 * window-specific, although two standard return codes are predefined:
	 * <code>OK</code> and <code>CANCEL</code>.
	 * </p>
	 * 
