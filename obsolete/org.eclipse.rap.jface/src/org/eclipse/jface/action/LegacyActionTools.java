...
public final class LegacyActionTools {
  ...
  /**
   * Maps standard keyboard modifier key names to the corresponding SWT modifier
  ...
  /**
   * Returns a string representation of an SWT modifier bit (SWT.CTRL, SWT.ALT,
   * SWT.SHIFT, and SWT.COMMAND). Returns <code>null</code> if the key code is
   * not an SWT modifier bit.
   * 
