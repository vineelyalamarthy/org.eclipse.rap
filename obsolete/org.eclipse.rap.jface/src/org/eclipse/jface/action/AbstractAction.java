...
public abstract class AbstractAction extends EventManager implements IAction {
   ...
   * registered, but calls <code>firePropertyChange(PropertyChangeEvent)</code>
   * if there are.
   * 
   * @param propertyName the name of the property that has changed
   * @param oldValue the old value of the property, or <code>null</code> if
   *          none
   * @param newValue the new value of the property, or <code>null</code> if
   *          none
   * @see IPropertyChangeListener#propertyChange
   */
