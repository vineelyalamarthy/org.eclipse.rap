 ...
 * implementation, {@link CoolBarManager}, which clients may instantiate or
 * subclass.
 * </p>
 * 
...
public interface ICoolBarManager extends IContributionManager {
  ...
  /**
   * A convenience method to add a tool bar as a contribution item to this cool
   * bar manager. Equivalent to
   * <code>add(new ToolBarContributionManager(toolBarManager))</code>.
   * 
   ...
   * context menu manager is used by the cool bar manager except for cool items
   ...
   * </p>
   * 
   * @param value <code>true</code> to lock the cool bar, <code>false</code>
   *          to unlock
   */
