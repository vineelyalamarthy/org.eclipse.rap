...
public abstract class ContributionManager implements IContributionManager {
   ...
   * @param append <code>true</code> to add to the end of the group, and
   ...
   * 
   * @param itemToAdd The contribution item to be added; may be
   *          <code>null</code>.
  ...
  // }
  /**
   * Returns whether this contribution manager contains dynamic items. A dynamic
   * contribution item contributes items conditionally, dependent on some
   * internal state.
   * 
  ...
  /**
   * The given item was added to the list of contributions. Marks the manager as
   * dirty and updates the number of dynamic items, and the memento.
   */
   ...
   * the current list of items, then this does nothing. If multiple occurrences
   * are found, then the replacement items is put in the first position and the
   * other positions are removed.
   * 
   ...
   * 
   * @param dirty <code>true</code> if this manager is dirty, and
