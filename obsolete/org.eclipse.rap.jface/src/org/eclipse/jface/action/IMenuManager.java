 ...
 * is also an <code>IContributionItem</code>, allowing sub-menus to be nested
 * in parent menus.
 * <p>
...
public interface IMenuManager extends IContributionManager, IContributionItem {
  ...
  /**
   * Adds a menu listener to this menu. Has no effect if an identical listener
  ...
  /**
   * Finds the manager for the menu at the given path. A path consists of
   * contribution item ids separated by the separator character. The path
   * separator character is <code>'/'</code>.
   * <p>
   * Convenience for <code>findUsingPath(path)</code> which extracts an
   * <code>IMenuManager</code> if possible.
   * </p>
   * 
   * @param path the path string
   * @return the menu contribution item, or <code>null</code> if there is no
   *         such contribution item or if the item does not have an associated
   *         menu manager
   */
  public IMenuManager findMenuUsingPath( String path );

  /**
   * Finds the contribution item at the given path. A path consists of
   * contribution item ids separated by the separator character. The path
   * separator character is <code>'/'</code>.
   * 
   * @param path the path string
   * @return the contribution item, or <code>null</code> if there is no such
   *         contribution item
   */
  public IContributionItem findUsingPath( String path );

  /**
   * Returns whether all items should be removed when the menu is about to show,
  ...
  /**
   * Removes the given menu listener from this menu. Has no effect if an
   ...
   * 
   * @param removeAll <code>true</code> if all items should be removed when
