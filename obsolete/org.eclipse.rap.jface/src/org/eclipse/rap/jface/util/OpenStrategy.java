...
public class OpenStrategy {
  ...
  /**
   * A single click will generate an open event but key arrows will not do
   * anything.
   * 
   * @deprecated
   */
  ...
  /**
   * A single click will generate an open event and key arrows will generate an
   * open event after a small time.
   * 
   * @deprecated
   */
  public static final int FILE_EXPLORER = SINGLE_CLICK | ARROW_KEYS_OPEN;
  /**
   * Pointing to an item will change the selection and a single click will
   * gererate an open event
   * 
   * @deprecated
   */
  ...
  /*
   * SINGLE_CLICK or DOUBLE_CLICK; In case of SINGLE_CLICK, the bits
   * SELECT_ON_HOVER and ARROW_KEYS_OPEN my be set as well.
   */
  ...
  /**
   * Returns the current used single/double-click method This method is internal
   * to the framework; it should not be implemented outside the framework.
   */
  ...
  /**
   * Set the current used single/double-click method. This method is internal to
   * the framework; it should not be implemented outside the framework.
   */
...
//            }
//            count[ 0 ]++;
//            // In the case of arrowUp/arrowDown when in the arrowKeysOpen mode,
//            // we
//            // want to delay any selection until the last arrowDown/Up occurs.
//            // This
//            // handles the case where the user presses arrowDown/Up
//            // successively.
...
//        /*
//         * ISSUE: May have to create a interface with method: setSelection(Point
//         * p) so that user's custom widgets can use this class. If we keep this
//         * option.
//         */
...
//          if( item != null ) {
//            table.setSelection( new TableTreeItem[]{
//              item
//            } );
//          }
//          selEvent.item = item;
