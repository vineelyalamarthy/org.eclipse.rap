...
public abstract class ContributionItem implements IContributionItem {
  ...
  /**
   * Creates a contribution item with a <code>null</code> id. Calls
   * <code>this(String)</code> with <code>null</code>.
   */
  ...
  /**
   * Creates a contribution item with the given (optional) id. The given id is
   * used to find items in a contribution manager, and for positioning items
  ...
  /**
   * The default implementation of this <code>IContributionItem</code> method
   * returns <code>false</code>. Subclasses may override.
   */
  ...
  /**
   * The default implementation of this <code>IContributionItem</code> method
   * returns <code>true</code>. Subclasses may override.
   */
  ...
  /**
   * The default implementation of this <code>IContributionItem</code> method
   * returns the value recorded in an internal state variable, which is
   * <code>true</code> by default. <code>setVisible</code> should be used to
   * change this setting.
   */
  ...
  /**
   * The default implementation of this <code>IContributionItem</code> method
   * stores the value in an internal state variable, which is <code>true</code>
   * by default.
   */
  ...
  /**
   * Returns a string representation of this contribution item suitable only for
   * debugging.
   */
  ...
  /**
   * The <code>ContributionItem</code> implementation of this method declared
   * on <code>IContributionItem</code> does nothing. Subclasses should
   * override to update their state.
   */
