...
public abstract class Action extends AbstractAction implements IAction {
  ...
  /*
   * The list of default values the action can have. These values will determine
...
//      firePropertyChange( IMAGE, oldImage, newImage );
   ...
   * '@' character. If neither, then there is no accelerator text. Note that if
   * you want to insert a '@' character into the text (but no accelerator, you
   * can simply insert a '@' or a tab at the end of the text.
   * </p>
   * 
  ...
  public void setText( String text ) {
    ...
    if( !( this.accelerator == oldAccel && ( oldText == null
                                                            ? this.text == null
