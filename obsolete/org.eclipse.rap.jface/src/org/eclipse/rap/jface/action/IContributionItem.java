 ...
 * <code>CoolBarManager</code>, </code>or a <code>StatusLineManager</code>.
 * </p>
 * <p>
...
public interface IContributionItem {
  ...
  /**
   * Disposes of this contribution item. Called by the parent contribution
   * manager when the manager is being disposed. Clients should not call this
   * method directly.
   * 
   * @since 2.1
   */
   ...
   * @param index the index where the controls are inserted, or <code>-1</code>
  ...
  /**
   * Returns the identifier of this contribution item. The id is used for
   * retrieving an item from its manager.
   * 
   * @return the contribution item identifier, or <code>null</code> if none
   */
  public String getId();
   ...
   * 
   * @return <code>true</code> if this item is dynamic, and <code>false</code>
   *         for normal items
   */
  public boolean isDynamic();

  /**
   * Returns whether this contribution item is a group marker. This information
   * is used when adding items to a group.
   * 
  ...
  /**
   * Returns whether this contribution item is a separator. This information is
   * used to enable hiding of unnecessary separators.
   * 
   ...
   * 
   * @return <code>true</code> if this item is visible, and <code>false</code>
   *         otherwise
   */
  public boolean isVisible();

  /**
   * Saves any state information of the control(s) owned by this contribution
   * item. The contribution manager calls this method before disposing of the
   * controls.
   * 
   * @since 3.0
   */
  ...
  /**
   * Updates any SWT controls cached by this contribution item with any changes
   * which have been made to this contribution item since the last update.
   * Called by contribution manager update methods.
   */
  public void update();

  /**
   * Updates any SWT controls cached by this contribution item with changes for
   * the the given property.
   * 
