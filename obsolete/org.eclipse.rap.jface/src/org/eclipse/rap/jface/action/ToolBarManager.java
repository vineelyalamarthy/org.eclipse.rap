 ...
 * </p>
 */
public class ToolBarManager extends ContributionManager
  implements IToolBarManager
{
  ...
  /**
   * Creates and returns this manager's tool bar control. Does not create a new
...
//  }
   ...
   * <p>
   * The default implementation of this framework method re-lays out the parent
   * when the number of items crosses the zero threshold. Subclasses should
   * override this method to implement their own re-layout strategy
   * 
   * @param layoutBar the tool bar control
...
//          }
   ...
   * the tool bar.
   * 
   * @param contextMenuManager the context menu manager, or <code>null</code>
   *          if none
   * @since 3.0
   */
