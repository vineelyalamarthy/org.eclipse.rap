...
public class ViewerComparator {
  ...
  /**
   * Creates a new {@link ViewerComparator}, which uses the given comparator to
   * sort strings.
   * 
   * @param comparator
   */
   ...
   * criterion.
   * <p>
   * The default implementation of this framework method returns <code>0</code>.
   * Subclasses may reimplement this method to provide non-trivial
   * categorization.
   * </p>
   * 
