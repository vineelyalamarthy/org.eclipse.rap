 ...
 * creating a <code>ListViewer</code> on an existing <code>List</code>
 * control). All viewers also provide a convenience constructor for creating the
 * control.
 * </p>
 * <p>
 ...
 * <li> support selections (<code>setSelection</code>,
 * <code>getSelection</code>) </li>
 * </ul>
 * </p>
 */
public abstract class Viewer implements IInputSelectionProvider {
   ...
   * <code>org.eclipse.swt.events.HelpListener</code>). Help request
   * listeners.
   * 
  ...
  /**
   * The names of this viewer's properties. <code>null</code> if this viewer
   * has no properties.
   * 
   * @see #setData
   */
  private String[] keys;
  /**
   * The values of this viewer's properties. <code>null</code> if this viewer
   * has no properties. This array parallels the value of the <code>keys</code>
   * field.
   * 
   * @see #setData
   */
  ...
  /**
   * Help listener for the control, created lazily when client's first help
   * listener is added.
   */
  ...
  /**
   * Adds a listener for help requests in this viewer. Has no effect if an
  ...
  /**
   * Notifies any help listeners that help has been requested. Only listeners
  ...
  /**
   * Returns the value of the property with the given name, or <code>null</code>
   * if the property is not found.
   * <p>
   * The default implementation performs a (linear) search of an internal table.
   * Overriding this method is generally not required if the number of different
   * keys is small. If a more efficient representation of a viewer's properties
   * is required, override both <code>getData</code> and <code>setData</code>.
   * </p>
   * 
  ...
  /*
   * (non-Javadoc) Copy-down of method declared on <code>IInputProvider</code>.
   */
  public abstract Object getInput();

  /*
   * (non-Javadoc) Copy-down of method declared on <code>ISelectionProvider</code>.
   */
  public abstract ISelection getSelection();

  /**
   * Handles a help request from the underlying SWT control. The default
   * behavior is to fire a help request, with the event's data modified to hold
   * this viewer.
   */
   ...
   * @param oldInput the old input element or <code>null</code> if there was
   *          previously no input
   */
  ...
  /**
   * Removes the given help listener from this viewer. Has no affect if an
   ...
   * display-relative coordinates. Returns the newly revealed Item, or
   * <code>null</code> if no scrolling occurred or if the viewer doesn't
   * represent an item-based widget.
   * 
  ...
  /**
   * Scrolls the viewer's control up by one item from the given display-relative
   * coordinates. Returns the newly revealed Item, or <code>null</code> if no
   * scrolling occurred or if the viewer doesn't represent an item-based widget.
   * 
   * @param x horizontal coordinate
   * @param y vertical coordinate
   */
  ...
  /**
   * Sets the value of the property with the given name to the given value, or
   * to <code>null</code> if the property is to be removed. If this viewer has
   * such a property, its value is replaced; otherwise a new property is added.
   * <p>
   * The default implementation records properties in an internal table which is
   * searched linearly. Overriding this method is generally not required if the
   * number of different keys is small. If a more efficient representation of a
   * viewer's properties is required, override both <code>getData</code> and
   * <code>setData</code>.
   * </p>
   * 
   * @param key the property name
   * @param value the property value, or <code>null</code> if the property is
   *          not found
   */
  public void setData( String key, Object value ) {
    ...
    if( value == null ) {
      ...
      if( keys.length == 1 ) {
        ...
        System.arraycopy( keys, index + 1, newKeys, index, newKeys.length
                                                           - index );
        System.arraycopy( values, 0, newValues, 0, index );
        System.arraycopy( values, index + 1, newValues, index, newValues.length
                                                               - index );
        keys = newKeys;
        values = newValues;
      }
