...
/**
 * A concrete implementation of the <code>IStructuredSelection</code>
...
public class StructuredSelection implements IStructuredSelection {
  ...
  /**
   * Returns whether this structured selection is equal to the given object. Two
   * structured selections are equal iff they contain the same elements in the
   * same order.
   * 
  ...
  /*
   * (non-Javadoc) Method declared in IStructuredSelection.
   */
  ...
  /*
   * (non-Javadoc) Method declared in ISelection.
   */
  ...
  public Iterator iterator() {
    return Arrays.asList( elements == null
                                          ? new Object[ 0 ]
                                          : elements ).iterator();
  }
  ...
  public String toString() {
    // return isEmpty() ? JFaceResources.getString("<empty_selection>") :
    // toList().toString(); //$NON-NLS-1$
    return isEmpty()
                    ? "Empty Selection"
                    : toList().toString();
  }
