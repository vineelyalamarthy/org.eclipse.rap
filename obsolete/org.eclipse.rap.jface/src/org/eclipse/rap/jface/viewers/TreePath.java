...
public final class TreePath {
   ...
   * 
   * @param segments path of elements to a leaf node in a tree, starting with
   *          the root element
   */
  ...
  /**
   * Returns a hash code computed from the hash codes of the segments, using the
   * given comparer to compute the hash codes of the segments.
   * 
   * @param comparer comparer to use or <code>null</code> if the segments'
   *          hash codes should be computed by calling their hashCode() methods.
   ...
   * @param comparer comparator to use or <code>null</code> if segments should
   *          be compared using equals()
  ...
  /**
   * Returns whether this path starts with the same segments as the given path,
   * using the given comparer to compare segments.
   * 
   * @param treePath path to compare to
   * @param comparer the comparer to use, or <code>null</code> if equals()
   *          should be used to compare segments
  ...
  /**
   * Returns a copy of this tree path with one segment removed from the end, or
   * <code>null</code> if this tree path has no segments.
   * 
   * @return a tree path
   */
