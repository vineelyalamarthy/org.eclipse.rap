...
public class TreeViewer extends AbstractTreeViewer {
  ...
  /**
   * TreeColorAndFontCollector is an helper class for color and font support for
   * trees that support the ITableFontProvider and the ITableColorProvider.
   * 
  ...
  private class TreeColorAndFontCollector {
    ...
    /**
     * Set the fonts and colors for the treeItem if there is a color and font
     * provider available.
     * 
...
//        }
   ...
   * correspond with the columns of the tree control. They are used to identify
   ...
   * <code>ITableLabelProvider</code> or <code>ILabelProvider</code>. If it
   * is an <code>ITableLabelProvider</code>, then it provides a separate
  ...
  protected void hookControl( Control control ) {
    ...
    // ILazyTreeContentProvider lazyContentProvider = (ILazyTreeContentProvider)
    // getContentProvider();
  ...
  /**
   * For a TreeViewer with a tree with the VIRTUAL style bit set, set the number
   * of children of the given element. To set the number of children of the
   * invisible root of the tree, the input object is passed as the element.
   * 
   * @param element
   * @param count <strong>EXPERIMENTAL</strong>. This class or interface has
   *          been added as part of a work in progress. There is no guarantee
   *          that this API will remain unchanged during the 3.2 release cycle.
   *          Please do not use this API without consulting with the Platform/UI
   *          team.
   *          </p>
   * @since 3.2
   */
   ...
   * index.
   * <p>
   * This method should be called by implementers of ILazyTreeContentProvider to
   * populate this viewer.
   * </p>
   * 
   ...
   * @see ILazyTreeContentProvider <strong>EXPERIMENTAL</strong>. This class or
   *      interface has been added as part of a work in progress. There is no
   *      guarantee that this API will remain unchanged during the 3.2 release
   *      cycle. Please do not use this API without consulting with the
   *      Platform/UI team.
   *      </p>
   * @since 3.2
   */
  ...
  protected Object getParentElement( Object element ) {
    // if(!(element instanceof TreePath) && (getContentProvider() instanceof
