...
public class InputDialog extends Dialog {
   ...
   * @param initialValue the initial input value, or <code>null</code> if
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.jface.window.Window#configureShell(org.eclipse.rap.rwt.widgets.Shell)
   */
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.jface.dialogs.Dialog#createButtonsForButtonBar(org.eclipse.rap.rwt.widgets.Composite)
   */
...
//    text.selectAll();
  ...
  protected Control createDialogArea( final Composite parent ) {
    ...
    // create message
    if ( message != null ) {
      Label label = new Label( composite, RWT.WRAP );
...
//  } );
    ...
    errorMessageText.setLayoutData(new GridData( GridData.GRAB_HORIZONTAL
                                                 | GridData.HORIZONTAL_ALIGN_FILL ) );
//    TODO [rst] fix backgroundColor as soon as getSystemColor exists
//    Color bgcolor = errorMessageText.getDisplay().getSystemColor( RWT.COLOR_WIDGET_BACKGROUND );
    Color bgColor = Color.getColor( 248, 248, 255 );    
    errorMessageText.setBackground( bgColor );
