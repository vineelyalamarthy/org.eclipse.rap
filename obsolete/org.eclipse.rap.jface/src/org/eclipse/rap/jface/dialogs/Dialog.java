...
import org.eclipse.rap.jface.util.Policy;
import org.eclipse.rap.jface.window.*;
...
//TODO [rst] once there is a image registry implementation, fill it with images
//for info, warning, and error message dialoges
///**
...
//  TODO [rst] adopt as soon text length calculation is implemented
//  GC gc = new GC(control);
...
//};
  ...
  protected Dialog(IShellProvider parentShell) {
    super(parentShell);
    setShellStyle( RWT.DIALOG_TRIM | RWT.APPLICATION_MODAL );
...
//  setBlockOnOpen(true);
                                 ...
                                 boolean defaultButton )
  {
    ...
    Button button = new Button( parent, RWT.PUSH );
  ...
  protected void initializeBounds() {
    ...
    // are initialized.
    computedSize = getShell().computeSize(RWT.DEFAULT, RWT.DEFAULT, true);  
...
//}
  ...
  protected void setButtonLayoutData( final Button button ) {
    ...
    Point minSize = button.computeSize( RWT.DEFAULT, RWT.DEFAULT, true );
   ...
   * @param button
   */
  protected void setButtonLayoutFormData( final Button button ) {
...
//  TODO [rst] uncomment as soon as there is a font registry
...
//      TODO [rst] uncomment when FontData is implemented
