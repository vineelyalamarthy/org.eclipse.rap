 ...
 ******************************************************************************/
package org.eclipse.rap.jface.internal.provisional.action;

import org.eclipse.rap.jface.action.IContributionItem;
import org.eclipse.rap.jface.action.IContributionManager;
...
public interface IToolBarContributionItem extends IContributionItem {
   ...
   * 
   * @return the parent contribution manager, or <code>null</code> TODO may
   *         not need this, getToolBarManager may be enough.
   */
