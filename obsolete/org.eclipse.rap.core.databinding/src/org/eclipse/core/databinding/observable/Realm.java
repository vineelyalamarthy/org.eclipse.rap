...
public abstract class Realm {
	...
	// This is done using a SessionRealm Session Singleton object 
	...
	public static Realm getDefault() {
		return SessionRealm.getInstance().getRealm();
	}
	...
	protected static Realm setDefault(Realm realm) {
		...
		SessionRealm.getInstance().setRealm(realm);
		return oldValue;
	}
