...
public class LayoutTree implements ISizeProvider {
  ...
  /**
   * Creates SWT controls owned by the LayoutTree (ie: the sashes). Does not
...
//  }
   ...
   * flag. For example, hasSizeFlag(false, SWT.MIN) returns true iff the
   * receiver enforces a minimum height, or hasSizeFlag(true, SWT.WRAP) returns
