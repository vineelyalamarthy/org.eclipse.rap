...
public class ProgressCanvasViewer extends AbstractProgressViewer {
  // TODO [fappel]: RWT Canvas has no functionality yet - so we use a 
  //                label for now...
    Label canvas;
//    Canvas canvas;
...
//        int charHeight = fm.getHeight();
        int charWidth = ( int )FontSizeEstimation.getAvgCharWidth( font );
        int charHeight = FontSizeEstimation.getCharHeight( font );
