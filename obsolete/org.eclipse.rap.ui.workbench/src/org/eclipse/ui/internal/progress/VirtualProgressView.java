...
//
///**
// * The VirtualProgressView is the class that shows the details of the current workbench
// * progress optimized for the display of visible items only.
// */
//public class VirtualProgressView extends ViewPart implements IViewPart {
//
...
//		viewer = new VirtualProgressViewer(parent, SWT.MULTI);
