 ...
 * but this reader handles multiple elements per extension. To start reading the
 * extensions from the registry for an extension point, call the method
 * <code>readRegistry</code>. To read children of an IConfigurationElement,
 * call the method <code>readElementChildren</code> from your implementation
 * of the method <code>readElement</code>, as it will not be done by default.
 */
public abstract class RegistryReader {
  ...
  protected static void logError( IConfigurationElement element, String text ) {
    ...
    buf.append( "Plugin " );
    buf.append( extension.getNamespace() );
    buf.append( ", extension " );
    buf.append( extension.getExtensionPointUniqueIdentifier() );
    buf.append( "\n" + text );//$NON-NLS-1$
    Activator.log( buf.toString() );
   ...
   * <code>readElement</code>. Logs an error if the element was not
   * recognized.
   */
