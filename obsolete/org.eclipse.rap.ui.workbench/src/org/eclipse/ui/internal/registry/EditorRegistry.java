 ...
 */
public class EditorRegistry extends SessionSingletonEventManager implements IEditorRegistry,
...
//                    WorkbenchMessages.EditorRegistry_errorMessage, null);
//            return false;
//        } catch (WorkbenchException e) {
//            ErrorDialog.openError((Shell) null, WorkbenchMessages.EditorRegistry_errorTitle,
//                    WorkbenchMessages.EditorRegistry_errorMessage,
...
//                    "Unable to save resource associations.", null); //$NON-NLS-1$
//            return;
//        }
//
...
//                    "Error", "Unable to save resource associations.", null); //$NON-NLS-1$ //$NON-NLS-2$
//            return;
//        }
    }
...
//    }
	...
	public ImageDescriptor getImageDescriptor(String filename, IContentType contentType) {
        ...
        anImage = null; //getSystemExternalEditorImageDescriptor(filename);
        if (anImage == null) {
