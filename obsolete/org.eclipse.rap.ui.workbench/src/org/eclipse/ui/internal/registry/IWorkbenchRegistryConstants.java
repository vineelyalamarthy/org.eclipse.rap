 ...
 * IBM Corporation - initial API and implementation Dan Rubel
 * <dan_rubel@instantiations.com> - Fix for bug 11490 - define hidden view
 * (placeholder for view) in plugin.xml
 ******************************************************************************/
...
public interface IWorkbenchRegistryConstants {
  ...
  /**
   * The name of the attribute storing the trigger sequence for a binding. This
   * is called a 'keySequence' for legacy reasons.
   */
