...
/**
 * Provides part selection tracking for a part with a specific id in all pages
 * of a specific workbench window. This tracker shields clients from a part
 * opening and closing, and still provides selection notification/information
 * even when the part is not active.
 */
