...
//                String text = ((Text) e.widget).getText();
    ...
    protected void selectFirstMatch() {
        ...
        if (element != null) {
        	// TODO: remove hack when we have multi selection in table
//			fTableViewer.setSelection(new StructuredSelection(element), true);
        	StructuredSelection sel = new StructuredSelection(element);
        	StructuredSelection sel2 = new StructuredSelection(sel.getFirstElement());
        	fTableViewer.setSelection(sel2, true);
		} else {
