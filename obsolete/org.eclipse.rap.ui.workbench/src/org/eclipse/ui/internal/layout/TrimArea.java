...
public class TrimArea {
  ...
  /**
   * The bitwise SWT modifiers that this trim area suggests, like SWT.TOP or
   * SWT.LEFT. The control modifiers determine the orientation, amongst other
   * things.
   * 
   ...
   * SWT.LEFT.
   * 
   * @param mod the bitwise OR of the SWT constants.
   */
