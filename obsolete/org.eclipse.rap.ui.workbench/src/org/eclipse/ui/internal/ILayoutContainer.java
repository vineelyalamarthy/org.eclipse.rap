...
//  public void findSashes( LayoutPart toFind, PartPane.Sashes result );
   ...
   * This method determines whether the parts in this container should
   * participate in this behavior. If this method returns true, its parts may
   * automatically be given focus when another part is closed.
   * 
   * @return true iff the parts in this container may be given focus when the
  ...
  /**
   * Returns true iff the given child is obscured due to the fact that the
   * container is zoomed into another part.
   * 
   * @param toTest
   * @return
   * @since 3.1
  ...
  /**
   * Returns true iff we are zoomed into the given part, given an immediate
