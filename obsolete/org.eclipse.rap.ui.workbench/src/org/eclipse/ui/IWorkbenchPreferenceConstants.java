...
public interface IWorkbenchPreferenceConstants {
   ...
   *             new perspective. Callers should use IWorkbench.showPerspective
   *             methods.
   */
   ...
   * <p>
   * Value is of type <code>String</code>. The possible values are defined by
   * the constants <code>OPEN_PERSPECTIVE_WINDOW, OPEN_PERSPECTIVE_PAGE, 
  ...
  /**
   * A preference value indicating that an action should open a new perspective
   * in a new window.
   * 
  ...
  /**
   * A preference value indicating that an action should open a new perspective
   * by replacing the current perspective.
   * 
   * @see #PROJECT_OPEN_NEW_PERSPECTIVE
   */
   ...
   * setup, since the fast view bar state is then persisted in the workbench.
   * This preference is intended for applications that want the initial docking
   * location to be somewhere specific. The default value (when this preference
   * is not set) is the bottom.
   * 
   * @see #LEFT
   * @see #BOTTOM
   * @see #RIGHT
   ...
   * tabs in editors and views. Boolean-valued: <code>true</code> if editors
   * and views should use a traditional style of tab and <code>false</code> if
   * editors should show new style tab (3.0 style)
   * <p>
   ...
   * perspective bar. Boolean-valued: <code>true</code>, if editors should
   * show text on the perspective bar, <code>false</code> otherwise.
   * <p>
   * The default value for this preference is: <code>true</code> (show text on
   * the perspective bar)
   * </p>
   * 
   * @since 3.0
  ...
  /**
   * A named preference for the text of the Help Contents action. String-valued.
   * If not specified, <code>"&Help Contents"</code> is used.
   * <p>
  ...
  /**
   * A named preference for the text of the Help Search action. String-valued.
   * If not specified, <code>"S&earch"</code> is used.
   * <p>
   * The default value for this preference is: <code>null</code>
   * </p>
   * 
  ...
  /**
   * A named preference for the text of the Dynamic Help action. String-valued.
   * If not specified, <code>"&Dynamic Help"</code> is used.
   * <p>
   * The default value for this preference is: <code>null</code>
   * </p>
   * 
  ...
  /**
   * <p>
   * Workbench preference id for the key configuration identifier to be treated
   * as the default.
   * </p>
   * <p>
   ...
   * saving the workbench state when exiting. The default is <code>false</code>.
   * 
   * @since 3.1
   */
   ...
   * set for newly created views (without previously stored state). This is a
   * hint that view implementors should honor.
   * 
   * @since 3.2
   */
  ...
  /**
   * Stores whether or not the workbench prompts for saving when a dirty editor
   * or view is closed, but the Saveable objects are still open in other parts.
   * If
