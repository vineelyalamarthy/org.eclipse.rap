 ...
 * </p>
 * 
 * @see org.eclipse.ui.IActionBars#setGlobalActionHandler Note: many of the
 *      remaining non-deprecated constants here are IDE-specific and should be
 *      deprecated and moved to a constant pool at the IDE layer (e.g.
 *      IIDEActionConstants).
 */
public interface IWorkbenchActionConstants {
   ...
   * constants. There doesn't seem to be much point for this. Recommend deleting
   * it. ]
   * </p>
   */
   ...
   * 
   * @deprecated in 3.0. Use
   *             {@link org.eclipse.ui.actions.ActionFactory#CLOSE_ALL
   ...
   * 
   * @deprecated in 3.0. Use
   *             {@link org.eclipse.ui.actions.ActionFactory#SAVE_ALL
   ...
   *             instead.
   */
  public static final String ADD_TASK = "addTask"; // Global action.
                                                    // //$NON-NLS-1$
  /**
   ...
   */
  public static final String REFRESH = "refresh"; // Global action.
                                                  // //$NON-NLS-1$
  /**
   ...
   * <code>"goInto"</code>).
   */
  public static final String GO_INTO = "goInto"; // Global action.
                                                  // //$NON-NLS-1$
  /**
   ...
   */
  public static final String GO_TO_RESOURCE = "goToResource"; // Global action.
                                                              // //$NON-NLS-1$
  /**
   ...
   */
  public static final String SYNC_EDITOR = "syncEditor"; // Global action.
                                                          // //$NON-NLS-1$
  /**
   ...
   */
  public static final String FORWARD = "forward"; // Global action.
                                                  // //$NON-NLS-1$
  /**
   ...
   * 
   * @deprecated in 3.0. Use
   *             {@link org.eclipse.ui.actions.ActionFactory#PREVIOUS
   *             ActionFactory.PREVIOUS.getId()} instead.
   */
  public static final String PREVIOUS = "previous"; // Global action.
                                                    // //$NON-NLS-1$
  /**
   ...
   *             instead.
   */
  public static final String BUILD_PROJECT = "buildProject"; // Global action.
                                                              // //$NON-NLS-1$
  /**
   ...
   *             instead.
   */
  public static final String REBUILD_PROJECT = "rebuildProject"; // Global
                                                                  // action.
                                                                  // //$NON-NLS-1$
  /**
   ...
   *             instead.
   */
  public static final String OPEN_PROJECT = "openProject"; // Global action.
                                                            // //$NON-NLS-1$
  /**
   ...
   *             instead.
   */
  public static final String CLOSE_PROJECT = "closeProject"; // Global action.
                                                              // //$NON-NLS-1$
  // end menu reorg
