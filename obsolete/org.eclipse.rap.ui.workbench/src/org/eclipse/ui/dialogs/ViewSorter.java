...
//                    .getLabel());
        	String str1 = ((IViewDescriptor) e1).getLabel();
        	String str2 = ((IViewDescriptor) e2).getLabel();
            ...
            String str1 = ((IViewCategory) e1).getLabel(); //DialogUtil.removeAccel(((IViewCategory) e1).getLabel());
            String str2 = ((IViewCategory) e2).getLabel(); //DialogUtil.removeAccel(((IViewCategory) e2).getLabel());
            return collator.compare(str1, str2);
        }
        return 0;
    }
