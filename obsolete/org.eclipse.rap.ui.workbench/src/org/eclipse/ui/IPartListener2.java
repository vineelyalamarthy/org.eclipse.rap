...
public interface IPartListener2 {
   ...
   * programmatically (via <code>IPerspective.bringToTop</code>). When a part
   * is activated by the user clicking on it, only <code>partActivated</code>
   * is sent.
   * </p>
   * 
   ...
   * notification is not sent. It is only sent when the view is being removed
   * from the page entirely (it is being disposed).
   * </p>
   * 
   ...
   * <p>
   * Note that if other perspectives in the same page share the view, this
   * notification is not sent. It is only sent when the view is being newly
   * opened in the page (it is being created).
   * </p>
   * 
