 ...
 * The extension defines a id, label, and <code>IPerspectiveFactory</code>. A
...
public interface IPerspectiveDescriptor {
  ...
  /**
   * Returns this perspective's label. For perspectives declared via an
   * extension, this is the value of its <code>"label"</code> attribute.
   * 
   * @return the label
   */
