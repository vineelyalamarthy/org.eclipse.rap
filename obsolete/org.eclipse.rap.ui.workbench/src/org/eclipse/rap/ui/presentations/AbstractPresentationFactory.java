...
public abstract class AbstractPresentationFactory {
  ...
  /**
   * Creates a standalone stack presentation for presenting a standalone view. A
   * standalone view cannot be docked together with other views. The title of a
   * standalone view may be hidden.
   * <p>
   * The presentation creates its controls under the given parent composite.
   * </p>
   * 
   ...
   * @param site the site used for communication between the presentation and
   *          the workbench
   * @param showTitle <code>true</code> to show the title for the view,
...
//  }
   ...
   * This is used to ensure that one presentation is not restored from mementos
   * saved by a different presentation.
   * 
