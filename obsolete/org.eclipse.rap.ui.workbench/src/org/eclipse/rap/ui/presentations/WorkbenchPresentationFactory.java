...
import org.eclipse.rap.ui.IWorkbenchPreferenceConstants;
...
import org.eclipse.rap.ui.internal.presentations.defaultpresentation.DefaultTabFolder;
// import org.eclipse.ui.internal.presentations.defaultpresentation.DefaultThemeListener;
import org.eclipse.rap.ui.internal.presentations.defaultpresentation.EmptyTabFolder;
...
//    .getInt( IPreferenceConstants.VIEW_TAB_POSITION );
                                                     ...
                                                     IStackPresentationSite site )
  {
     ...
     * for expert users (i.e., via the plug-in customization file). Bug 32789.
     */
...
//                                  folder );
                                                             ...
                                                             boolean showTitle )
  {
    ...
    TabbedStackPresentation presentation = new TabbedStackPresentation( site,
                                                                        folder,
                                                                        new StandardViewSystemMenu( site ) );
    return presentation;
  }
