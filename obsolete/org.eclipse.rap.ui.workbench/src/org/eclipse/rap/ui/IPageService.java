...
public interface IPageService {
  ...
  /*
   * Returns the active page. @return the active page, or <code>null</code> if
   * no page is currently active
   */
  public IWorkbenchPage getActivePage();

  /**
   * Removes the given page listener. Has no affect if an identical listener is
   * not registered.
   * 
   * @param listener a page listener
   */
  ...
  /**
   * Removes the given page's perspective listener. Has no affect if an
