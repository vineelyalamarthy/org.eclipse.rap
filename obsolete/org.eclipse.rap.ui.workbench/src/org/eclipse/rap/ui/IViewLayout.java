...
public interface IViewLayout {
   ...
   * 
   * @return <code>true</code> if the view is closeable, <code>false</code>
   *         if not
   */
   ...
   * 
   * @return <code>true</code> if the view is moveable, <code>false</code>
   *         if not
   */
   ...
   * 
   * @param moveable <code>true</code> if the view is moveable,
   *          <code>false</code> if not
   */
