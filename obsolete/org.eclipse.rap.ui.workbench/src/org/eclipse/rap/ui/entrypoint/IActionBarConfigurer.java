...
//  public IStatusLineManager getStatusLineManager();
   ...
   * <p>
   * For a workbench retarget action ({@link org.eclipse.ui.actions.RetargetAction RetargetAction})
   * to work, it must be registered. You should also register actions that will
   * participate in custom key bindings.
   * </p>
   * 
