...
import org.eclipse.rap.ui.internal.presentations.PaneFolder;
import org.eclipse.rap.ui.internal.presentations.PaneFolderButtonListener;
import org.eclipse.rap.ui.internal.presentations.util.*;
...
//      fireEvent( TabFolderEvent.EVENT_SHOW_LIST );
   ...
   * @param allowMax
   */
  public DefaultTabFolder( Composite parent,
                           int flags,
                           boolean allowMin,
                           boolean allowMax )
  {
...
//                                           SWT.FLAT | SWT.NO_BACKGROUND );
      ...
      ToolItem pullDownButton = new ToolItem( actualToolBar, RWT.PUSH );
...
//    paneFolder.setTabHeight( computeTabHeight() );
  ...
  /**
   * Changes the minimum number of characters to display in the pane folder tab.
...
//    paneFolder.setSimpleTab( simple );
  ...
  public AbstractTabItem add( int index, int flags ) {
    DefaultTabItem result = new DefaultTabItem( ( CTabFolder )getFolder().getControl(),
                                                index,
                                                flags );
...
//      }
//      if( toTest.y >= displayBounds.y
//          && toTest.y < displayBounds.y + displayBounds.height )
//      {
//        return true;
//      }
//    }
...
//  }
  ...
  public void setColors( DefaultTabFolderColors colors,
                         int activationState,
  ...
  private void updateColors() {
    ...
    paneFolder.setSelectionBackground( currentColors.background,
                                       currentColors.percentages,
                                       currentColors.vertical );
  }
...
//    int tabHeight = Math.max( viewToolBar.computeSize( SWT.DEFAULT, SWT.DEFAULT ).y,
