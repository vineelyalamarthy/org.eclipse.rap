 ...
 ******************************************************************************/
package org.eclipse.rap.ui.internal.misc;

import org.eclipse.core.runtime.Platform;
import org.eclipse.rap.ui.IPerspectiveDescriptor;
import org.eclipse.rap.ui.IWorkbenchPage;
...
public class UIListenerLogging {
  ...
  public final static String PAGE_PARTLISTENER_EVENTS = PlatformUI.PLUGIN_ID
                                                        + "/listeners/IWorkbenchPage.IPartListener"; //$NON-NLS-1$
  public final static String PAGE_PARTLISTENER2_EVENTS = PlatformUI.PLUGIN_ID
                                                         + "/listeners/IWorkbenchPage.IPartListener2"; //$NON-NLS-1$
  private final static String PAGE_PROPERTY_EVENTS = PlatformUI.PLUGIN_ID
                                                     + "/listeners/IWorkbenchPage.IPropertyChangeListener"; //$NON-NLS-1$
  private final static String WINDOW_PAGE_EVENTS = PlatformUI.PLUGIN_ID
                                                   + "/listeners/IWorkbenchWindow.IPageListener"; //$NON-NLS-1$
  private final static String WINDOW_PERSPECTIVE_EVENTS = PlatformUI.PLUGIN_ID
                                                          + "/listeners/IWorkbenchWindow.IPerspectiveListener"; //$NON-NLS-1$
  public final static String WINDOW_PARTLISTENER_EVENTS = PlatformUI.PLUGIN_ID
                                                          + "/listeners/IWorkbenchWindow.IPartListener"; //$NON-NLS-1$
  public final static String WINDOW_PARTLISTENER2_EVENTS = PlatformUI.PLUGIN_ID
                                                           + "/listeners/IWorkbenchWindow.IPartListener2"; //$NON-NLS-1$
  private final static String PARTREFERENCE_PROPERTY_EVENTS = PlatformUI.PLUGIN_ID
  ...
  public static final void logPageEvent( IWorkbenchWindow window,
                                         IWorkbenchPage page,
                                         String eventId )
  {
  ...
  public static final void logPerspectiveEvent( IWorkbenchWindow window,
                                                IWorkbenchPage page,
  ...
  public static final void logPerspectiveChangedEvent( IWorkbenchWindow window,
                                                       IWorkbenchPage page,
                                                       IPerspectiveDescriptor descriptor,
  ...
  public static final void logPerspectiveSavedAs( IWorkbenchWindow window,
                                                  IWorkbenchPage page,
                                                  IPerspectiveDescriptor oldDescriptor,
                                                  IPerspectiveDescriptor newDescriptor )
  {
    if( isEnabled( WINDOW_PERSPECTIVE_EVENTS ) ) {
      System.out.println( WINDOW_PERSPECTIVE_EVENTS
                          + " " + getWindowId( window ) //$NON-NLS-1$
   ...
   * @param eventId
   */
  public static final void logPartListenerEvent( String sourceType,
                                                 Object source,
                                                 IWorkbenchPart part,
                                                 String eventId )
  {
   ...
   * @param eventId
   */
  public static final void logPartListener2Event( String sourceType,
                                                  Object source,
   ...
   * @param eventId
   */
  public static final void logPartListenerEvent( IWorkbenchPage page,
                                                 IWorkbenchPart part,
                                                 String eventId )
  {
   ...
   * @param eventId
   */
  public static final void logPartListener2Event( IWorkbenchPage page,
                                                  IWorkbenchPartReference part,
                                                  String eventId )
  {
   ...
   * @param eventId
   */
  public static final void logPagePropertyChanged( IWorkbenchPage page,
                                                   String changeId,
                                                   Object oldValue,
                                                   Object newValue )
  {
  ...
  public static final void logPartReferencePropertyChange( IWorkbenchPartReference ref,
                                                           int changeId )
  {
    if( isEnabled( PARTREFERENCE_PROPERTY_EVENTS ) ) {
      ...
      switch( changeId ) {
        case IWorkbenchPartConstants.PROP_TITLE:
          eventDescription = "title";break; //$NON-NLS-1$
        case IWorkbenchPartConstants.PROP_DIRTY:
          eventDescription = "dirty";break; //$NON-NLS-1$
        case IWorkbenchPartConstants.PROP_INPUT:
          eventDescription = "input";break; //$NON-NLS-1$
        case IWorkbenchPartConstants.PROP_PART_NAME:
          eventDescription = "part_name";break; //$NON-NLS-1$
        case IWorkbenchPartConstants.PROP_CONTENT_DESCRIPTION:
          eventDescription = "content_description";break; //$NON-NLS-1$
        default:
  ...
  private static boolean internal_isEnabled( String eventName ) {
    ...
    return option != null
           && !option.equalsIgnoreCase( "false" ) && !option.equalsIgnoreCase( "-1" ); //$NON-NLS-1$ //$NON-NLS-2$
  }
}
