...
//import org.eclipse.rap.ui.presentations.PresentationUtil;
...
//  };
  ...
  /**
   * Returns the location where the pane menu should be opened when activated by
   * a keyboard shortcut (display coordinates)
   * 
...
//  }
   ...
   * in this tab folder. Subclasses should override this if the underlying SWT
   * widget has an equivalent method
   * 
  ...
  /**
   * Returns the title area for this control (in the control's coordinate
   * system)
   * 
   * @return
   */
...
//  }
   ...
   * default, double-clicking, context menus, and drag/drop are disabled on the
   * folder's border.
   * 
  ...
  /**
   * Set the folder to visible. This can be extended to propogate the visibility
   * request to other components in the subclass.
   * 
   * @param visible <code>true</code> - the folder is visible.
   * @since 3.2
   */
