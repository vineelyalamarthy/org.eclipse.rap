...
import org.eclipse.rap.jface.viewers.ContentViewer;
import org.eclipse.rap.jface.viewers.IBaseLabelProvider;
import org.eclipse.rap.jface.viewers.IFontProvider;
...
import org.eclipse.rap.jface.viewers.LabelProvider;
//import org.eclipse.rap.jface.viewers.TableViewer;
import org.eclipse.rap.jface.viewers.Viewer;
import org.eclipse.rap.jface.viewers.ViewerSorter;
import org.eclipse.rap.rwt.RWT;
import org.eclipse.rap.rwt.graphics.Font;
//import org.eclipse.rap.rwt.graphics.FontData;
...
public class BasicPartList extends AbstractTableInformationControl {
  ...
  private class BasicStackListLabelProvider extends LabelProvider
...
//        boldFont.dispose();
    ...
    public int compare( Viewer viewer, Object e1, Object e2 ) {
      ...
      if( viewer == null || !( viewer instanceof ContentViewer ) ) {
        ...
        if( prov instanceof ILabelProvider ) {
          ...
          // DefaultEditorPresentation.getLabelText which returns the name of
          // dirty
          // files begining with dirty prefix, sorting should not take dirty
          // prefix in consideration
  ...
  public BasicPartList( Shell parent,
                        int shellStyle,
                        int treeStyle,
...
//  }
  ...
  protected boolean deleteSelectedElements() {
    ...
    if( structuredSelection != null ) {
      ...
      site.close( ( IPresentablePart[] )list.toArray( new IPresentablePart[ list.size() ] ) );
    }
