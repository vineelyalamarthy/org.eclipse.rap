...
import org.eclipse.rap.ui.IPartListener;
 ...
 * specific workbench page. This selection provider sheilds clients from a debug
  ...
  implements IPartListener, ISelectionChangedListener
{
  ...
  /**
   * Disposes this selection provider - removes all listeners currently
   * registered.
   */
  public void dispose() {
    setPart( null, false );
  ...
  /**
   * The selection has changed in the part being tracked. Forward it to the
   * listeners.
   * 
  ...
  /**
   * Returns the part this is tracking, or <code>null</code> if it is not open
   * 
