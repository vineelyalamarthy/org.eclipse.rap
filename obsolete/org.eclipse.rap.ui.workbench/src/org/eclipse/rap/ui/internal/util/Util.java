 ...
 ******************************************************************************/
package org.eclipse.rap.ui.internal.util;
...
public final class Util {
   ...
   * strings, and leaves any other string unmodified. Use this to help wrap
   * calls to methods that return null instead of the empty string. Can also
   * help protect against implementation errors in methods that are not supposed
   * to return null.
   * 
  ...
  public static int compare( Object left, Object right ) {
    if( left == null && right == null ) {
      ...
      return compare( System.identityHashCode( left ),
   ...
   * @param right The right-hand side of the comparison; may be
   *          <code>null</code>.
   * @return <code>0</code> if they are the same, <code>-1</code> if left is
   *         <code>null</code>;<code>1</code> if right is
   *         <code>null</code>. Otherwise, the left identity hash code minus
   *         the right identity hash code.
   */
  ...
  public static void diff( Map left,
                           Map right,
                           Set leftOnly,
                           Set different,
                           Set rightOnly )
   ...
   * <code>null</code>.
   * 
   * @param leftArray The left array to compare; may be <code>null</code>,
  ...
  public static Collection safeCopy( Collection collection,
                                     Class c,
  ...
  public static Map safeCopy( Map map,
                              Class keyClass,
                              Class valueClass,
  ...
  public static SortedMap safeCopy( SortedMap sortedMap,
                                    Class keyClass,
                                    Class valueClass )
  {
                                        ...
                                        boolean trim )
  {
    if( resourceBundle != null && key != null ) {
      try {
        ...
        if( signal ) {
          Activator.log( eMissingResource );
        }
      }
    }
    return trim
  ...
  public static void arrayCopyWithRemoval( Object[] src,
                                           Object[] dst,
                                           int idxToRemove )
  {
    if( src == null
        || dst == null
        || src.length - 1 != dst.length
        || idxToRemove < 0
    ...
    if( idxToRemove == 0 ) {
      ...
      System.arraycopy( src, idxToRemove + 1, dst, idxToRemove, src.length
                                                                - idxToRemove
                                                                - 1 );
    }
  }
  ...
  public static IWorkbenchWindow getWorkbenchWindowForShell( Shell shellToCheck )
  {
    ...
    if( workbenchWindow == null ) {
      // TODO: [fappel] implementation of getActiveWorkbenchWindow()
