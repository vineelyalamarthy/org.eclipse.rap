...
import org.eclipse.rap.ui.internal.IWorkbenchThemeConstants;
//import org.eclipse.ui.internal.WorkbenchMessages;
import org.eclipse.rap.ui.internal.presentations.util.PartInfo;
import org.eclipse.rap.ui.internal.presentations.util.WidgetTabItem;
...
//    super( new CTabItem( parent, flags, index ) );
    super( new CTabItem( parent, flags ) );
    updateFont();
  }
...
//    FontRegistry registry = PlatformUI.getWorkbench()
//      .getThemeManager()
//      .getCurrentTheme()
//      .getFontRegistry();
...
//    }
//    if( !contentDescription.equals( "" ) ) { //$NON-NLS-1$
//      text = MessageFormat.format( WorkbenchMessages.EditorPart_AutoTitleFormat,
//                                   new String[]{
