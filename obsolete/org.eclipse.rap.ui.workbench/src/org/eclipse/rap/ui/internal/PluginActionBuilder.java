...
import org.eclipse.rap.ui.internal.registry.RegistryReader;
...
public abstract class PluginActionBuilder extends RegistryReader {
   ...
   */
  public final void contribute( IMenuManager menu,
  ...
  /**
   * Reads the contributions from the registry for the provided workbench part
   * and the provided extension point ID.
   */
  ...
  protected static class BasicContribution {
    ...
    /**
     * Contributes submenus and/or actions into the provided menu and tool bar
     * managers. The elements added are filtered based on activity enablement.
     * 
     * @param menu the menu to contribute to
     ...
     */
    public void contribute( IMenuManager menu,
    ...
    /**
     * Creates a named menu group marker from the information in the
     * configuration element. If the marker already exists do not create a
     * second.
     */
    ...
    /**
     * Inserts the separator or group marker into the menu. Subclasses may
     * override.
     */
