...
public class PerspectiveDescriptor
  implements IPerspectiveDescriptor//, IPluginContribution
{
...
//  private ImageDescriptor image;
   ...
   */
  public PerspectiveDescriptor( String id,
                                String label,
...
//      this.image = originalDescriptor.image;
  ...
  public IPerspectiveFactory createFactory() throws CoreException {
    IPerspectiveFactory result = null;
    ...
    if( originalId != null ) {
      ...
      PerspectiveRegistry registry
        = ( PerspectiveRegistry )PerspectiveRegistry.getInstance();
      IPerspectiveDescriptor target
        = ( registry ).findPerspectiveWithId( originalId );
      result =   target == null 
               ? null
               : ( ( PerspectiveDescriptor )target ).createFactory();
      
      // otherwise try to create the executable extension
    } else if( configElement != null ) {
      try {
        String clazz = IWorkbenchRegistryConstants.ATT_CLASS;
        Object instance = configElement.createExecutableExtension( clazz );
        result = ( IPerspectiveFactory )instance;
...
//  }
  ...
  public String getDescription() {
    return configElement == null
                                ? description
                                : RegistryReader.getDescription( configElement );
  }
  ...
  public boolean getFixed() {
    return configElement == null
                                ? fixed
                                : Boolean.valueOf( configElement.getAttribute( IWorkbenchRegistryConstants.ATT_FIXED ) )
                                  .booleanValue();
  }
...
//        if( icon != null ) {
//          image = AbstractUIPlugin.imageDescriptorFromPlugin( configElement.getNamespace(),
//                                                              icon );
//        }
//        if( image == null ) {
...
//  }
  ...
  public String getLabel() {
    return configElement == null
                                ? label
                                : configElement.getAttribute( IWorkbenchRegistryConstants.ATT_NAME );
  }
...
//  }
  ...
  public boolean hasDefaultFlag() {
    ...
    return Boolean.valueOf( configElement.getAttribute( IWorkbenchRegistryConstants.ATT_DEFAULT ) )
      .booleanValue();
  }
  ...
  public boolean isSingleton() {
    return configElement == null
                                ? singleton
                                : configElement.getAttributeAsIs( IWorkbenchRegistryConstants.ATT_SINGLETON ) != null;
  }
