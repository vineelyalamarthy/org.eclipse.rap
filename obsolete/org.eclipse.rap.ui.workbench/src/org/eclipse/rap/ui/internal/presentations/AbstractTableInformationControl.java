...
import org.eclipse.rap.jface.viewers.ILabelProvider;
import org.eclipse.rap.jface.viewers.IStructuredSelection;
import org.eclipse.rap.jface.viewers.StructuredSelection;
//import org.eclipse.rap.jface.viewers.TableViewer;
import org.eclipse.rap.jface.viewers.Viewer;
import org.eclipse.rap.jface.viewers.ViewerFilter;
import org.eclipse.rap.rwt.RWT;
import org.eclipse.rap.rwt.events.DisposeListener;
//import org.eclipse.rap.rwt.events.FocusListener;
//import org.eclipse.rap.rwt.events.KeyEvent;
//import org.eclipse.rap.rwt.events.KeyListener;
//import org.eclipse.rap.rwt.events.ModifyEvent;
//import org.eclipse.rap.rwt.events.ModifyListener;
//import org.eclipse.rap.rwt.events.MouseAdapter;
//import org.eclipse.rap.rwt.events.MouseEvent;
//import org.eclipse.rap.rwt.events.MouseMoveListener;
import org.eclipse.rap.rwt.events.SelectionAdapter;
import org.eclipse.rap.rwt.events.SelectionEvent;
import org.eclipse.rap.rwt.events.SelectionListener;
import org.eclipse.rap.rwt.graphics.Color;
//import org.eclipse.rap.rwt.graphics.FontMetrics;
//import org.eclipse.rap.rwt.graphics.GC;
...
//import org.eclipse.rap.ui.internal.WorkbenchMessages;
import org.eclipse.rap.ui.internal.misc.StringMatcher;
import org.eclipse.rap.ui.internal.presentations.defaultpresentation.DefaultTabItem;
...
//  private TableViewer fTableViewer;
   ...
   * @param controlStyle the additional styles for the control
   */
                                          ...
                                          int controlStyle )
  {
    ...
    fShell.setBackground( display.getSystemColor( RWT.COLOR_BLACK ) );
    // Composite for filter text and viewer
//    fComposite = new Composite( fShell, RWT.RESIZE );
    fComposite = new Composite( fShell, RWT.NONE );
...
//        if( e.character == RWT.ESC ) {
//          dispose();
//        } else if( e.character == RWT.DEL ) {
//          removeSelectedItems();
//          e.character = RWT.NONE;
//          e.doit = false;
//        }
//      }
//
...
//     * Linux-GTK on mouse move. Rather then removing the support altogether this
//     * feature has been worked around for GTK only as we expect that newer
//     * versions of GTK will no longer exhibit this quality and we will be able
//     * to have the desired support running on all platforms. See comment
//     * https://bugs.eclipse.org/bugs/show_bug.cgi?id=62405#c22 TODO: remove this
//     * code once bug 62405 is fixed for the mainstream GTK version
//     */
//    final int ignoreEventCount = Platform.getWS().equals( Platform.WS_GTK )
//                                                                           ? 4
//                                                                           : 1;
...
//              // Scroll up
//              Item item = fTableViewer.scrollUp( e.x + tableLoc.x, e.y
//                                                                   + tableLoc.y );
...
//              // Scroll down
//              Item item = fTableViewer.scrollDown( e.x + tableLoc.x,
//                                                   e.y + tableLoc.y );
//              if( item instanceof TableItem ) {
//                fLastItem = ( TableItem )item;
//                table.setSelection( new TableItem[]{
...
//        }
//        if( e.button == 3 ) {
//          TableItem tItem = fTableViewer.getTable().getItem( new Point( e.x,
//                                                                        e.y ) );
//          if( tItem != null ) {
//            Menu menu = new Menu( fTableViewer.getTable() );
//            MenuItem mItem = new MenuItem( menu, RWT.NONE );
...
//      }
//    } );
//    int border = ( ( shellStyle & RWT.NO_TRIM ) == 0 )
//                                                      ? 0
//                                                      : BORDER;
...
//  }
  ...
  protected Text createFilterText( Composite parent ) {
    fFilterText = new Text( parent, RWT.NONE );
    GridData data = new GridData();
//    GC gc = new GC( parent );
//    gc.setFont( parent.getFont() );
//    FontMetrics fontMetrics = gc.getFontMetrics();
//    gc.dispose();
//    data.heightHint = org.eclipse.jface.dialogs.Dialog.convertHeightInCharsToPixels( fontMetrics,
//                                                                                     1 );
...
//          gotoSelectedElement();
//        }
//        if( e.keyCode == RWT.ARROW_DOWN ) {
//          fTableViewer.getTable().setFocus();
//          fTableViewer.getTable().setSelection( 0 );
//        }
//        if( e.keyCode == RWT.ARROW_UP ) {
//          fTableViewer.getTable().setFocus();
//          fTableViewer.getTable().setSelection( fTableViewer.getTable()
//            .getItemCount() - 1 );
//        }
//        if( e.character == 0x1B ) {
//          dispose();
...
//    } );
    ...
    Label separator = new Label( parent, RWT.SEPARATOR
                                         | RWT.HORIZONTAL
                                         /*| RWT.LINE_DOT */);
  ...
  private void setInfoSystemColor() {
    Display display = fShell.getDisplay();
//    setForegroundColor( display.getSystemColor( RWT.COLOR_INFO_FOREGROUND ) );
//    setBackgroundColor( display.getSystemColor( RWT.COLOR_INFO_BACKGROUND ) );
  }
...
//    } );
   ...
   * the view and selects the first macthed element
   */
...
//    Point tableSize = viewerTable.computeSize( RWT.DEFAULT, RWT.DEFAULT );
//    int tableMaxHeight = fComposite.getDisplay().getBounds().height / 2;
//    // removes padding if necessary
//    int tableHeight = ( tableSize.y <= tableMaxHeight )
//                                                       ? tableSize.y
...
//    Point fCompSize = fComposite.computeSize( RWT.DEFAULT, RWT.DEFAULT );
...
//    return fTableViewer != null && fTableViewer.getInput() != null;
  ...
  public Point computeSizeHint() {
    return fShell.computeSize( RWT.DEFAULT, RWT.DEFAULT );
  }
