...
import org.eclipse.rap.ui.IPartListener2;
import org.eclipse.rap.ui.IPartService;
...
public class PartService implements IPartService {
  ...
  private void firePartActivated( IWorkbenchPartReference ref ) {
    ...
    if( part != null ) {
      UIListenerLogging.logPartListenerEvent( debugListenersKey,
                                              this,
                                              part,
                                              UIListenerLogging.PE_ACTIVATED );
      listeners.firePartActivated( part );
    }
    UIListenerLogging.logPartListener2Event( debugListeners2Key,
                                             this,
                                             ref,
  ...
  public void firePartBroughtToTop( IWorkbenchPartReference ref ) {
    ...
    if( part != null ) {
      UIListenerLogging.logPartListenerEvent( debugListenersKey,
                                              this,
                                              part,
                                              UIListenerLogging.PE_PART_BROUGHT_TO_TOP );
  ...
  public void firePartClosed( IWorkbenchPartReference ref ) {
    ...
    if( part != null ) {
      UIListenerLogging.logPartListenerEvent( debugListenersKey,
                                              this,
                                              part,
                                              UIListenerLogging.PE_PART_CLOSED );
  ...
  private void firePartDeactivated( IWorkbenchPartReference ref ) {
    ...
    if( part != null ) {
      UIListenerLogging.logPartListenerEvent( debugListenersKey,
                                              this,
                                              part,
                                              UIListenerLogging.PE_PART_DEACTIVATED );
  ...
  public void firePartOpened( IWorkbenchPartReference ref ) {
    ...
    if( part != null ) {
      UIListenerLogging.logPartListenerEvent( debugListenersKey,
                                              this,
                                              part,
                                              UIListenerLogging.PE_PART_OPENED );
