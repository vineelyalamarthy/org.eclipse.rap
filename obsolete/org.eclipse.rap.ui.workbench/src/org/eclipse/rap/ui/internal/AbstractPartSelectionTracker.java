...
import org.eclipse.rap.ui.INullSelectionListener;
...
public abstract class AbstractPartSelectionTracker {
  ...
  /**
   * Returns the selection from the part being tracked, or <code>null</code>
  ...
  /**
   * Disposes this selection tracker. This removes all listeners currently
   * registered.
   */
  public void dispose() {
