 ...
 * effect methods like {@link #dock(int) }, {@link #getControl() },
...
public interface IWindowTrim {
  ...
  /**
   * Called to notify the trim object that it has been docked on the given side
   * of the layout
   * 
   * @param dropSide the trim drop area
   */
  ...
  /**
   * Determines whether a particular trim can be 'closed' using the common Trim
   * UI.
   * 
  ...
  /**
   * Overrides the preferred width of the control (pixels). If SWT.DEFAULT, then
   * the control's preferred width will be used. This has no effect for
  ...
  /**
   * If true, the control will be resized with the layout. If there is more than
   * one resizable control on the same side of the layout, the available space
   * will be divided equally among all the resizeable controls.
   * 
