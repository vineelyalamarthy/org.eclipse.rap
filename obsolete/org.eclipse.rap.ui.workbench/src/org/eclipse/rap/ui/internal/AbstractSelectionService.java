...
import org.eclipse.rap.jface.viewers.IPostSelectionProvider;
import org.eclipse.rap.jface.viewers.ISelection;
import org.eclipse.rap.jface.viewers.ISelectionChangedListener;
import org.eclipse.rap.jface.viewers.ISelectionProvider;
import org.eclipse.rap.jface.viewers.SelectionChangedEvent;
...
public abstract class AbstractSelectionService implements ISelectionService {
  ...
  /**
   * The active part's selection provider, remembered in case the part replaces
   * its selection provider after we hooked a listener.
   */
  private ISelectionProvider activeProvider;
  /**
   * Map from part id (String) to per-part tracker
   * (AbstractPartSelectionTracker).
   */
  private Hashtable perPartTrackers;
  /**
   * The JFace selection listener to hook on the active part's selection
   * provider.
   */
  ...
  /**
   * The JFace post selection listener to hook on the active part's selection
   * provider.
   */
  ...
  // firePostSelection(newPart, sel);
  // } else {
  // //Reset active part. activeProvider may not be null next time this method
  // is called.
  // activePart = null;
  // }
  // }
  // // No need to fire an event if no active provider, since this was done in
  // reset()
  // }
  //
  // /**
