 ...
 ******************************************************************************/
package org.eclipse.rap.ui.actions;
...
import org.eclipse.rap.ui.internal.QuitAction;
...
//      action.setToolTipText( NLS.bind( WorkbenchMessages.AboutAction_toolTip,
//                                       productName ) );
//      return action;
//    }
//  };
...
//  };
  /**
   * Workbench action (id "back"): Back. This action is a {@link RetargetAction}
...
//                                                       WorkbenchMessages.Workbench_back );
...
//  };
  /**
   * Workbench action (id "closeAllPerspectives"): Closes all perspectives. This
...
//  };
  /**
   * Workbench action (id "copy"): Copy. This action is a {@link RetargetAction}
...
//  };
  /**
   * Workbench action (id "cut"): Cut. This action is a {@link RetargetAction}
...
//  };
   ...
   * {@link RetargetAction} with id "delete". This action maintains its
   * enablement state.
   */
...
//      window.getWorkbench()
//        .getHelpSystem()
//        .setHelp( action, IWorkbenchHelpContextIds.DELETE_RETARGET_ACTION );
//      ISharedImages sharedImages = window.getWorkbench().getSharedImages();
...
//  };
  /**
   * Workbench action (id "editActionSets"): Edit the action sets. This action
   * maintains its enablement state.
   */
...
//  };
  /**
   * Workbench action (id "find"): Find. This action is a {@link RetargetAction}
...
//      }
//      RetargetAction action = new LabelRetargetAction( getId(),
//                                                       WorkbenchMessages.Workbench_forward );
...
//  };
   ...
   * {@link RetargetAction} with id "goInto". This action maintains its
   * enablement state.
   */
...
//      }
//      RetargetAction action = new LabelRetargetAction( getId(),
//                                                       WorkbenchMessages.Workbench_goInto );
...
//  };
  /**
   * Workbench action (id "minimize"): Minimizes the active part. This action
   * maintains its enablement state.
   * 
   * @since 3.1
   */
...
//  };
  /**
   * Workbench action (id "move"): Move. This action is a {@link RetargetAction}
...
//  };
  /**
   * Workbench action (id "new"): Opens the new wizard dialog. This action
   * maintains its enablement state.
   */
...
//  };
   ...
   * shows the new wizard drop down, or opens the new wizard dialog when
   * pressed. For use in the toolbar. This action maintains its enablement
   * state.
   * 
   * @since 3.1
   */
...
//  };
  /**
   * Workbench action (id "next"): Next. This action is a {@link RetargetAction}
...
//      }
//      RetargetAction action = new LabelRetargetAction( getId(),
//                                                       WorkbenchMessages.Workbench_next );
...
//  };
  /**
   * Workbench action (id "nextEditor"): Next editor. This action maintains its
   * enablement state.
   * <p>
   * <code>NEXT_EDITOR</code> and <code>PREVIOUS_EDITOR</code> form a cycle
   * action pair. For a given window, use
   * {@link ActionFactory#linkCycleActionPair ActionFactory.linkCycleActionPair</code>}
   * to connect the two.
   * </p>
   */
...
//  };
   ...
   * {@link RetargetAction} with id "paste". This action maintains its
   * enablement state.
   */
...
//  };
  /**
   * Workbench action (id "preferences"): Displays the Preferences dialog. This
   * action maintains its enablement state.
   */
...
//      }
//      RetargetAction action = new LabelRetargetAction( getId(),
//                                                       WorkbenchMessages.Workbench_previous );
...
//  };
  /**
   * Workbench action (id "previousPart"): Previous part. This action maintains
...
//  };
   ...
   * {@link RetargetAction} with id "print". This action maintains its
   * enablement state.
   */
...
//      action.setImageDescriptor( WorkbenchImages.getImageDescriptor( IWorkbenchGraphicConstants.IMG_ETOOL_PRINT_EDIT ) );
//      action.setDisabledImageDescriptor( WorkbenchImages.getImageDescriptor( IWorkbenchGraphicConstants.IMG_ETOOL_PRINT_EDIT_DISABLED ) );
//      return action;
//    }
//  };
  /**
...
//  };
  ...
  /**
   * Workbench action (id "redo"): Redo. This action is a {@link RetargetAction}
...
//  };
   ...
   * {@link RetargetAction} with id "refresh". This action maintains its
   * enablement state.
   */
...
//  };
   ...
   * {@link RetargetAction} with id "rename". This action maintains its
   * enablement state.
   */
...
//  };
   ...
   * {@link RetargetAction} with id "revert". This action maintains its
   * enablement state.
   */
...
//  };
  /**
   * Workbench action (id "save"): Save the active editor. This action maintains
   * its enablement state.
   */
...
//  };
  /**
   * Workbench action (id "saveAs"): Save As for the active editor. This action
   * maintains its enablement state.
   */
...
//  };
  /**
   * Workbench action (id "savePerspective"): Save the current perspective. This
   * action maintains its enablement state.
   */
...
//  };
  /**
   * Workbench action (id "undo"): Undo. This action is a {@link RetargetAction}
...
//  };
  /**
   * Workbench action (id "up"): Up. This action is a {@link RetargetAction}
...
//      }
//      RetargetAction action = new LabelRetargetAction( getId(),
//                                                       WorkbenchMessages.Workbench_up );
...
//  };
  /**
   * Workbench action (id "helpSearch"): Open the help search. This action is
   * always enabled.
   * 
   * @since 3.1
   */
...
//  };
  /**
   * Workbench action (id "dynamicHelp"): Open the dynamic help. This action is
   * always enabled.
   * 
   * @since 3.1
   */
...
//  };
  /**
   * Workbench action (id "openPerspectiveDialog"): Open the Open Perspective
...
//  };
  /**
   * Workbench action (id "newEditor"): Open a new editor on the active editor's
