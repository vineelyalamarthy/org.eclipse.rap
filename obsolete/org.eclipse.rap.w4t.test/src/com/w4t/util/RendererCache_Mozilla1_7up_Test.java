...
import com.w4t.dhtml.treeleafkit.TreeLeafRenderer_Mozilla1_6up_Script;
...
public class RendererCache_Mozilla1_7up_Test extends TestCase {

  public void testNoscript() {
    Renderer renderer;
    //
    // Mozilla1_7 up (no script)
    W4TFixture.fakeBrowser( new Mozilla1_7up( false ) );
    // WebAnchor
    ...
    assertEquals( MenuItemRenderer_Mozilla1_6up_Noscript.class,
                  renderer.getClass() );
    // MenuItemSeparator
    renderer = cache.retrieveRenderer( MenuItemSeparator.class );
    assertEquals( MenuItemSeparatorRenderer_Mozilla1_6up_Noscript.class,
                  renderer.getClass() );
    // TreeLeaf
    ...
    assertEquals( MenuRenderer_Mozilla1_6up_Noscript.class, 
                  renderer.getClass() );
    // MenuBar
    renderer = cache.retrieveRenderer( MenuBar.class );
    assertEquals( MenuBarRenderer_Mozilla1_6up_Noscript.class,
                  renderer.getClass() );
    // TreeNode
    ...
    assertEquals( MenuButtonRenderer_Mozilla1_6up_Noscript.class,
                  renderer.getClass() );
    // WebButton
    ...
    assertEquals( WebCardLayoutRenderer_Mozilla1_6up_Noscript.class,
                  renderer.getClass() );
  }
  ...
  public void testScript() {
    ...
    // TreeLeaf
    renderer = cache.retrieveRenderer( TreeLeaf.class );
    assertEquals( TreeLeafRenderer_Mozilla1_6up_Script.class,
                  renderer.getClass() );
    // Menu
    renderer = cache.retrieveRenderer( Menu.class );
    ...
    // MenuBar
    renderer = cache.retrieveRenderer( MenuBar.class );
    assertEquals( MenuBarRenderer_Mozilla1_6up_Script.class,
                  renderer.getClass() );
    // TreeNode
    renderer = cache.retrieveRenderer( TreeNode.class );
    assertEquals( TreeNodeRenderer_Mozilla1_6up_Script.class,
                  renderer.getClass() );
    // TreeView
    renderer = cache.retrieveRenderer( TreeView.class );
    assertEquals( TreeViewRenderer_Mozilla1_6up_Script.class,
                  renderer.getClass() );
    // MenuButton
    renderer = cache.retrieveRenderer( MenuButton.class );
  ...
  public void testAjax() {
    ...
    // MenuBar
    renderer = cache.retrieveRenderer( MenuBar.class );
    assertEquals( MenuBarRenderer_Mozilla1_6up_Ajax.class, 
                  renderer.getClass() );
    // TreeNode
    renderer = cache.retrieveRenderer( TreeNode.class );
    assertEquals( TreeNodeRenderer_Mozilla1_6up_Ajax.class, 
                  renderer.getClass() );
    // TreeView
    renderer = cache.retrieveRenderer( TreeView.class );
    assertEquals( TreeViewRenderer_Mozilla1_6up_Ajax.class, 
                  renderer.getClass() );
    // MenuButton
    renderer = cache.retrieveRenderer( MenuButton.class );
    ...
    // WebFileUpload
    renderer = cache.retrieveRenderer( WebFileUpload.class );
    assertEquals( WebFileUploadRenderer_Mozilla1_6up_Ajax.class,
                  renderer.getClass() );
    // WebImage
    renderer = cache.retrieveRenderer( WebImage.class );
    ...
    // WebSelect
    renderer = cache.retrieveRenderer( WebSelect.class );
    assertEquals( WebSelectRenderer_Mozilla1_6up_Ajax.class,
                  renderer.getClass() );
    // WebText
    renderer = cache.retrieveRenderer( WebText.class );
    ...
    // WebCardLayout
    renderer = cache.retrieveRenderer( WebCardLayout.class );
    assertEquals( WebCardLayoutRenderer_Mozilla1_6up_Ajax.class,
                  renderer.getClass() );
  }
