...
public class RendererCache_Ie5up_Test extends TestCase {

  public void testNoscript() {
    Renderer renderer;
    //
    // IE5 up (no script)
    W4TFixture.fakeBrowser( new Ie5up( false ) );
    // WebAnchor
    ...
    assertEquals( MenuButtonRenderer_Ie5up_Noscript.class, renderer.getClass() );
    // WebButton
