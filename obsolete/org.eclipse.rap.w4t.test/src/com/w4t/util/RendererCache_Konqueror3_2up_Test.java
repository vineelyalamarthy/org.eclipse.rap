...
import com.w4t.dhtml.treeleafkit.TreeLeafRenderer_Konqueror3_2up_Script;
import com.w4t.dhtml.treenodekit.TreeNodeRenderer_Default_Noscript;
import com.w4t.dhtml.treenodekit.TreeNodeRenderer_Konqueror3_2up_Script;
import com.w4t.dhtml.treeviewkit.TreeViewRenderer_Default_Noscript;
import com.w4t.dhtml.treeviewkit.TreeViewRenderer_Konqueror3_2up_Script;
...
public class RendererCache_Konqueror3_2up_Test extends TestCase {
  ...
  public void testScript() {
    ...
    // TreeLeaf
    renderer = cache.retrieveRenderer( TreeLeaf.class );
    assertEquals( TreeLeafRenderer_Konqueror3_2up_Script.class,
                  renderer.getClass() );
    // Menu
    renderer = cache.retrieveRenderer( Menu.class );
    ...
    // TreeNode
    renderer = cache.retrieveRenderer( TreeNode.class );
    assertEquals( TreeNodeRenderer_Konqueror3_2up_Script.class,
                  renderer.getClass() );
    // TreeView
    renderer = cache.retrieveRenderer( TreeView.class );
    assertEquals( TreeViewRenderer_Konqueror3_2up_Script.class,
                  renderer.getClass() );
    // MenuButton
    renderer = cache.retrieveRenderer( MenuButton.class );
