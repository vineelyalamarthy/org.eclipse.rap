...
public class RendererCache_Mozilla1_6up_Test extends TestCase {

  public void testNoscript() {
    Renderer renderer;
    //
    // Mozilla1_6 up (no script)
    W4TFixture.fakeBrowser( new Mozilla1_6up( false ) );
    // WebAnchor
  ...
  public void testAjax() {
    ...
    assertEquals( TreeNodeRenderer_Mozilla1_6up_Ajax.class, 
                  renderer.getClass() );
    renderer = cache.retrieveRenderer( TreeLeaf.class );
    assertEquals( TreeLeafRenderer_Mozilla1_6up_Ajax.class, 
                  renderer.getClass() );
    // WebFileUpload
    renderer = cache.retrieveRenderer( WebFileUpload.class );
