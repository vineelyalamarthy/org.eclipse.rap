...
public class BrowserLoader_Test extends TestCase {
  ...
  public void testSafari() {   
    ...
    assertEquals( com.w4t.util.browser.Safari2.class, browser.getClass() );   
  ...
  public void testNetscapeMozilla() {
    ...
    browser = BrowserLoader.load();  
    assertEquals( com.w4t.util.browser.Mozilla1_6.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_NETSCAPE_7_1_WIN );
    browser = BrowserLoader.load();
    assertEquals( com.w4t.util.browser.Mozilla1_6.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_NETSCAPE_8_WIN );
    browser = BrowserLoader.load();
    assertEquals( com.w4t.util.browser.Mozilla1_7.class, browser.getClass() ); 
    assertNoSystemOut();
  }
  ...
  public void testOpera() {
    ...
    browser = BrowserLoader.load();  
    assertEquals( com.w4t.util.browser.Default.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_OPERA_7_23_WIN_2K );
    browser = BrowserLoader.load();  
    assertEquals( com.w4t.util.browser.Default.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_OPERA_8_WIN );
    browser = BrowserLoader.load();  
    assertEquals( com.w4t.util.browser.Opera8.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_OPERA_9_WIN );
    browser = BrowserLoader.load();  
    assertEquals( com.w4t.util.browser.Opera9.class, browser.getClass() ); 
    assertNoSystemOut();
  }
  ...
  public void testIE() {
    ...
    browser = BrowserLoader.load();
    assertEquals( com.w4t.util.browser.Ie5.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_IE_5_5_WIN );
    browser = BrowserLoader.load();
    assertEquals( com.w4t.util.browser.Ie5_5.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_IE_6_0_WIN );
    browser = BrowserLoader.load();
    assertEquals( com.w4t.util.browser.Ie6.class, browser.getClass() ); 
    Fixture.fakeUserAgent( USERAGENT_IE_7_0_WIN );
    browser = BrowserLoader.load();
    assertEquals( com.w4t.util.browser.Ie7.class, browser.getClass() );
