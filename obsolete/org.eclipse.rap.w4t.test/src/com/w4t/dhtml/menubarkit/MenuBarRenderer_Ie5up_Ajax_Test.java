...
public class MenuBarRenderer_Ie5up_Ajax_Test extends RenderingTestCase {

  public MenuBarRenderer_Ie5up_Ajax_Test( final String name ) {
    super( name );
    setGenerateResources( false );
  }

  public void testIe5up() throws Exception {
    //
    // Ie5up
  ...
  private static void assertJSLibrary() {
    ...
    assertEquals( "Wrong number of JavaScript libraries", 
                  1, 
                  libraries.length );
    assertEquals( "resources/js/menubar/menubar_ie.js", libraries[ 0 ] );
  }
}
//$endOfPublicClass
class Render_14_css {
