...
//			fHistorySize= SearchPreferencePage.getHistoryLimit();
		...
		protected Control createDialogArea(Composite container) {
			...
			PixelConverter converter = new PixelConverter( fHistorySizeTextField );
			gridData.widthHint= converter.convertWidthInCharsToPixels(6);
...
//		});
        ...
        gd.widthHint= converter.convertWidthInCharsToPixels(15);
        gd.widthHint= converter.convertWidthInCharsToPixels(WIDTH_IN_CHARACTERS);
...
//		fLink.setText(Messages.format(SearchMessages.SearchHistorySelectionDialog_configure_link_label, new Integer(historyLimit)));
	 ...
	 */
	protected void createButtonsForButtonBar(Composite parent) {
		createButton(parent, IDialogConstants.OK_ID, IDialogConstants.get().OPEN_LABEL, true);
