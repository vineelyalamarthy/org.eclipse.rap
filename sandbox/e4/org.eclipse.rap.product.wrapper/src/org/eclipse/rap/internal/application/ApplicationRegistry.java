...
public class ApplicationRegistry {
  ...
  private static final String CURRENT_ENTRY_POINT = EntryPointManager.class
                                                    .getName()
  ...
  public static synchronized IApplication getApplication() {
    ...
    final Class clazz = ( Class )appEntrypointMapping.get( currentEntryPoint );
    try {
  ...
  private static void registerApplication( final IConfigurationElement configElement )
  {
    final String contributorName = configElement.getContributor().getName();
    final IConfigurationElement[] runElement = configElement.getChildren( RUN );
    final String className = runElement[ 0 ].getAttribute( "class" );
    final String applicationId = contributorName + ".application";
    try {
      ...
      final Object[] params = new Object[]{ className, applicationId };
  ...
  public static void registerApplicationEntryPoints() {
    final IExtensionPoint point = getApplicationExtensionPoint();
