...
public class FilterDialog extends TrayDialog {
	...
	private void createEventTypesGroup(Composite parent) {
		...
		infoButton.setText(PDERuntimeMessages.get().LogView_FilterDialog_information); 
		...
		warningButton.setText(PDERuntimeMessages.get().LogView_FilterDialog_warning); 
		...
		errorButton.setText(PDERuntimeMessages.get().LogView_FilterDialog_error); 
	...
	private void createLimitSection(Composite parent) {
		...
		limit.setText(PDERuntimeMessages.get().LogView_FilterDialog_limitTo); 
	...
	private void createSessionSection(Composite parent) {
		...
		label.setText(PDERuntimeMessages.get().LogView_FilterDialog_eventsLogged); 
		
		showAllButton = new Button(container, SWT.RADIO);
		showAllButton.setText(PDERuntimeMessages.get().LogView_FilterDialog_allSessions); 
