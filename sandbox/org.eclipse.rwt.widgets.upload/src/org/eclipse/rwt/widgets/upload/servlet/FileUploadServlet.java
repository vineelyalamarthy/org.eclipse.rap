...
public class FileUploadServlet extends HttpServlet implements Servlet {
    ...
    throws ServletException, IOException
  {
    ...
    final StringBuffer buffy = new StringBuffer( "<?xml version=\"1.0\" encoding=\"utf-8\"?><response>" );
    long bytesRead = 0;
    ...
    if( session != null ) {
      ...
      // buffy.append( "<?xml version=\"1.0\" encoding=\"utf-8\"?><response>" );
      if( listener != null ) {
        ...
        buffy.append( "<bytes_read>" )
          .append( bytesRead )
          .append( "</bytes_read><content_length>" )
        ...
        if( contentLength != 0 ) {
          if( bytesRead == contentLength ) {
            ...
            buffy.append( "<percent_complete>" )
              .append( ( ( 100 * bytesRead ) / contentLength ) )
    ...
    try {
      ...
      while( i.hasNext() ) {
        ...
        if( ( !fileItem.isFormField() ) && ( fileItem.getSize() > 0 ) ) {
          ...
          String myFileName = myFullFileName.substring( startIndex + 1,
                                                        myFullFileName.length() );
          // Write the uploaded file to the system
          fileItem.write( new File( filePath, myFileName ) );
        }
      }
