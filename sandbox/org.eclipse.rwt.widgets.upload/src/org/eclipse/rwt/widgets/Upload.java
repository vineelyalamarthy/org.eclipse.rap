...
public class Upload extends Composite {
  ...
  {
    Iterator listeners = uploadListeners.iterator();
  ...
  public final void dispose() {
    Iterator listeners = uploadListeners.iterator();
    while( listeners.hasNext() ) {
      this.uploadListeners.remove( ( UploadAdapter )listeners.next() );
    }
    super.dispose();
  }
}
