package org.eclipse.rap.rwt.visualization.google.internal.json;
 ...
 */
        class Obj implements JSONString {
            ...
            public Obj(String string, double n, boolean b, Date d) {
                this.aString = string;
                this.aNumber = n;
                this.aBoolean = b;
                this.aDate = d;
    	...
    	Obj obj = new Obj("A beany object", 42, true, new Date());
