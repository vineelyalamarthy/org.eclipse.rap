...
final class AdlibResourcesUtil {
  ...
  private static final String ADLIB_JS = "AdLib.js";
...
//    "org/eclipse/swt/graphics/GC.js",
  ...
  private AdlibResourcesUtil() {
    // prevent instance creation
  }

  public static void registerResources() {
    ClassLoader loader = AdlibResourcesUtil.class.getClassLoader();
  ...
  private static void registerWidgetImages() {
    IResourceManager manager = ResourceManager.getInstance();
    ClassLoader classLoader = AdlibResourcesUtil.class.getClassLoader();
